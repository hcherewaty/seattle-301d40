...
//      This refers to the instance of Joe from that was created using the Student constructor function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//      This refers to the the global window object when joe.scopeArrow() is invoked.
// 3. Explain why "this" is different when an arrow function is used.
//      This is different when the arrow function is used, because arrow functions affect scope.  When used, their scope bubbles up
//      to the next nearest scope as they do not bind "this".  If only arrow functions are used in a file, then their scope becomes the global window object.
