...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT:  Because we're using a console.log on a variable that holds a function, thus we're trying to console.log the function makeRandom() 
  console.log(viewed);
